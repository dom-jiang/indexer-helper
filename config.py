...
try:
    ...
    MAINNET_RPC_URL= ["https://rpc.mainnet.near.org", "https://near.drpc.org", "https://free.rpc.fastnear.com", "https://rpc.mainnet.pagoda.co"]
...
try:
    from db_info import MARKET_KEY, MARKET_URL, AUTH_SWITCH, NOT_AUTH_LIST, SIGN_EXPIRE, CRYPTO_AES_KEY, REF_URL, REF_SDK_URL, DB3_URL, DB3_ACCESS_KEY, DB3_START_ID
except ImportError:
    MARKET_KEY = ""
    MARKET_URL = ""
    AUTH_SWITCH = True
...
try:
    from db_info import ZCASH_SIGNER_ACCOUNT_ID, ZCASH_SIGNER_PRIVATE_KEY, ZCASH_RPC_URL, ZCASH_RPC_USER, ZCASH_RPC_PWD, INTENTS_API_KEY
except ImportError:
...
HYPERLIQUID_PERMIT_API_BASE = "http://172.17.0.1:8081"
...
try:
    from db_info import HYPERLIQUID_PERMIT_API_BASE as _HL_PERMIT_BASE
    HYPERLIQUID_PERMIT_API_BASE = _HL_PERMIT_BASE
except ImportError:
    pass

# Hyperliquid mainnet (HL main / UI exchange — used by Perps worker)
HYPERLIQUID_MAINNET_INFO_URL = "https://api.hyperliquid.xyz/info"
HYPERLIQUID_MAINNET_EXCHANGE_URL = "https://api-ui.hyperliquid.xyz/exchange"

try:
    from db_info import (
        HYPERLIQUID_MAINNET_INFO_URL as _HL_INFO,
        HYPERLIQUID_MAINNET_EXCHANGE_URL as _HL_EX,
    )
    HYPERLIQUID_MAINNET_INFO_URL = _HL_INFO
    HYPERLIQUID_MAINNET_EXCHANGE_URL = _HL_EX
except ImportError:
    pass
...
class Cfg:
    ...
    TOKENS = {
        ...
        "MAINNET": [
            ...
            {"SYMBOL": "USDC", "NEAR_ID": "16.contract.portalbridge.near",
             "MD_ID": "v2.ref-finance.near|NA|17208628f84f5d6ad33f0da3bbbeb27ffcb398eac501a31bd6ad2011e36133a1",
             "DECIMAL": 6},
            {"SYMBOL": "CORGI", "NEAR_ID": "corgi.token0.near", "MD_ID": "v2.ref-finance.near|5383|wrap.near",
             "DECIMAL": 18},
            {"SYMBOL": "KAT", "NEAR_ID": "kat.token0.near", "MD_ID": "v2.ref-finance.near|5391|wrap.near",
             "DECIMAL": 18},
            {"SYMBOL": "GP", "NEAR_ID": "gp.token0.near", "MD_ID": "v2.ref-finance.near|5422|wrap.near", "DECIMAL": 18},
            {"SYMBOL": "CHILL", "NEAR_ID": "chill-129.meme-cooking.near", "MD_ID": "v2.ref-finance.near|5462|wrap.near",
             "DECIMAL": 18},
            {"SYMBOL": "zNEARnM-USDC", "NEAR_ID": "v1.guild-covenant.near", "MD_ID": "v2.ref-finance.near|5442|wrap.near",
             "DECIMAL": 18},
            {"SYMBOL": "4illia", "NEAR_ID": "4illia-222.meme-cooking.near",
             "MD_ID": "v2.ref-finance.near|5494|wrap.near", "DECIMAL": 18},
            {"SYMBOL": "gnear", "NEAR_ID": "gnear-229.meme-cooking.near", "MD_ID": "v2.ref-finance.near|5502|wrap.near",
             "DECIMAL": 18},
            {"SYMBOL": "mpDAO", "NEAR_ID": "mpdao-token.near", "MD_ID": "v2.ref-finance.near|5438|meta-pool.near",
             "DECIMAL": 6},
            {"SYMBOL": "gnuff", "NEAR_ID": "gnuff-283.meme-cooking.near", "MD_ID": "v2.ref-finance.near|5539|wrap.near",
             "DECIMAL": 18},
            ...
            {"SYMBOL": "CHICA", "NEAR_ID": "token.bocachica_mars.near", "MD_ID": "v2.ref-finance.near|3886|wrap.near",
             "DECIMAL": 18},
            {"SYMBOL": "BST", "NEAR_ID": "509a38b7a1cc0dcd83aa9d06214663d9ec7c7f4a.factory.bridge.near",
             "MD_ID": "v2.ref-finance.near|3840|wrap.near", "DECIMAL": 18},
            {"SYMBOL": "CZ", "NEAR_ID": "cz.token0.near", "MD_ID": "v2.ref-finance.near|5283|wrap.near", "DECIMAL": 18},
            {"SYMBOL": "Darai", "NEAR_ID": "darai.tkn.near", "MD_ID": "v2.ref-finance.near|5123|wrap.near",
             "DECIMAL": 18},
            {"SYMBOL": "Hijack", "NEAR_ID": "hijack-252.meme-cooking.near",
             "MD_ID": "v2.ref-finance.near|5519|wrap.near", "DECIMAL": 18},
            {"SYMBOL": "BULLA", "NEAR_ID": "bulla.tkn.near", "MD_ID": "v2.ref-finance.near|5517|wrap.near",
             "DECIMAL": 18},
    ...
    INTENTS_API_KEY = INTENTS_API_KEY
