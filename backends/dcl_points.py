...
def handel_dcl_points():
    dcl_pool_list = []
    request_url = "https://api.rhea.finance/pool/search?type=dcl&sort=24h&limit=30&labels=&offset=0&hide_low_pool=false&hide_uncertified_token=false&order_by=desc&token_type=&token_list=&pool_id_list="
    ...
    for pool_id in dcl_pool_list:
        request_url = "https://api.ref.finance/get-dcl-points?pool_id=" + pool_id
