...
pid=`ps -ef | grep "swap_status_checker.py MAINNET" | grep -v grep | /usr/bin/awk '{print $2}'`
...
/usr/local/bin/python swap_status_checker.py MAINNET >> backend_swap_status_checker.log
echo 'OK'
