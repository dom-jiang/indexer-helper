...
def add_burrow_event_log(data_list, network_id):
    ...
    sql = "insert into burrow_event_log(event, account_id, amount, token_id, receipt_id, block_id, predecessor_id, " \
          ...
          "total_booster_amount, total_x_booster_amount, `timestamp`, create_time, position, args, collateral_assets," \
          "repaid_assets) values(%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,now(),%s,%s,%s,%s)"
