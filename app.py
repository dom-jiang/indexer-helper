...
from redis_provider import list_token_price_by_id_list, get_proposal_hash_by_id, get_token_price_report, get_whitelisted_tokens, get_24h_pool_volume, get_dcl_pools_volume_list, get_24h_pool_volume_list
...
@app.route('/get-whitelisted-tokens', methods=['GET'])
@flask_cors.cross_origin()
def handle_whitelisted_tokens():
    ...
    if contract_id is None or contract_id == "":
        return ""
    ret = get_whitelisted_tokens(Cfg.NETWORK_ID, contract_id)
    return compress_response_content(ret)
